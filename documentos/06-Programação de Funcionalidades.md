...
o acesso da Pagina inicial  tem o cabeçalho com a pagina de 
 ...
 e um botão que é redirecionado a pagina de cadastro .  As estruturas de dados foram baseadas em HTML, CSS e JS.
...
2. Ao entrar, terá acesso a página inicial.
...
1. Abra um navegador de Internet e informe a seguinte https://icei-puc-minas-pmv-ads.github.io/pmv-ads-2024-1-e1-proj-web-t14-health-web/codigo-fonte/index.html
...
3. Após cadastrar, terá acesso a tela inicial.
...
### Requisitos atendidos
RF-004 O site deve permitir ao usuário acessar os vídeos disponíveis e enviar sugestões.
...
1. Abra um navegador de Internet e informe a seguinte URL: https://icei-puc-minas-pmv-ads.github.io/pmv-ads-2024-1-e1-proj-web-t14-health-web/codigo-fonte/index.html
2. Faça cadastro/login no site.
3. Clique em Vídeos no cabeçalho e terá acesso aos vídeos.
...
O acesso a tela de receitas poderá ser feito através da opção do menu “Alimentação”.  As estruturas de dados foram baseadas em HTML, CSS e JS.

Exemplo da tela de Alimentação:
...
O site deve permitir acesso a página de Alimentação com receitas, e entrar em contato com nutricionistas.
...
3. Ao clicar em Alimentação terá acesso a área.
