...
Clicar em Meu Perfil se estiver logado.5. Visualizar a página e conferir informações de cadastro. 6. Upar uma imagem para foto de perfil.7. Atualizar, se escolher, as conquistas nos gráficos.|
