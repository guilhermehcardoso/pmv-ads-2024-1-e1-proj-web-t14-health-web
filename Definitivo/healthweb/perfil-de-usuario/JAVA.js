...
var sexo = getParametroURL('sexo');
var altura = getParametroURL('altura');
...
// Verifica se há dados no objeto JSON
if (dadosJSON) {
    var peso = getParametro('sexo', dadosJSON);
    var altura = getParametro('altura', dadosJSON);
    console.log('sexo:', peso); // Output: Peso: 70
    console.log('Altura:', altura); // Output: Altura: 180
} else {
    console.log('Vá Calcular seu Peso e quantidade de Agua ideias!.');
}
